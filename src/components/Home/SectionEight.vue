<template>
    <section class="w-screen md:h-screen bg-[#fffcf9]">
        <article class="md:p-9 grid md:place-content-center md:place-items-center">
            <div class=" md:px-33 md:w-[70%] px-5 mx-auto md:smy-[4rem]">
                ...
                <div class="grid place-content-center place-items-center">
                    <div class="group  md:inline-block">
                             <button class="border-[3px] text-center my-7 mx-auto border-[#000] font-bold px-6 py-3 bg-white  text-[#1d1e21] group-hover:text-white group-hover:bg-[#202054] transition ease-in duration-300 blue-shadow">Learn More
                              </button>
                        </div>
                </div>
            </div>
