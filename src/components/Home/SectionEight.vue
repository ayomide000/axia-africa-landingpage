            ...
            <div class=" md:px-33 md:w-[70%] px-5 mx-auto my-[4rem]">
                ...
                <div class="grid place-content-center place-items-center">
                    <div class="group my-[5rem] mr-[5rem]">
                        <button
                        class="border-[3px] w-[7rem] border-slate-900 p-3 bg-white absolute z-10 text-[#1d1e21] group-hover:text-white group-hover:bg-[#202054] transition ease-in duration-300"
                        >
                        Learn More
                        </button>
                        <button
                        class="p-3 ml-1 h-[2.6rem] absolute mt-4 z-1 w-[7rem] bg-[#202054] group-hover:bg-[#cb974d] transition ease-in duration-300"
                        ></button>
                    </div>
                </div>
            </div>
